        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <!DOCTYPE html>
                    ...
                    <h3>Barang Keluar</h3>
                    <a href="/BarangKeluar/printAll" class="btn btn-light" target="_blank">
                    <img src="https://img.icons8.com/material-rounded/24/000000/print.png"/></a>
                    <!-- search -->
                    ...
                    <table id="myTable" class="table">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>{{ $ts->qty }}</td>
                                @role('Admin-Purchasing|Manager-Purchasing')
                                <td>Rp. {{ $ts->harga_satuan }}</td>
                                <td>Rp. {{ $ts->jumlah }}</td>
                                @endrole
                                <td>{{ $ts->nama_by }}</td>
                                <td><a href="/BarangKeluar/print/{{ $ts->id }}" class="btn btn-light" target="_blank">
                                <img src="https://img.icons8.com/material-rounded/24/000000/print.png"/></a></td>
                                <!-- <td>
