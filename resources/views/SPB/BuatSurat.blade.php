        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <!DOCTYPE html>
                    ...
                    <h3>Surat Permintaan Barang (SPB)</h3>
                    <a class='btn btn-dark' href='tambah_SPB'>Tambah Surat SPB</a>
                        <!-- search -->
                    ...
                    <table id="myTable" class="table">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>{{ $s->nama_by }}</td>
                                <td>
                                <a href="/SPB/editSPB/{{ $s->id_SPB }}">Edit</a>
				                    |
				                <a href="/SPB/delete/{{ $s->id_SPB }}">Hapus</a>
                                </td>
                            </tr>
                            @endforeach
                            </tbody>
