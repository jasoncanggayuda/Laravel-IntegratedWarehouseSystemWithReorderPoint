            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <!DOCTYPE html>
                    ...
                    <body>
						...
						<a href="/PO/TerimaSPB"> Kembali</a>
						
						<br/>
						<br/>
                        
                        @foreach($valid_spb as $s)
						<form action="/PO/TerimaPO/storeTerimaPO" method="post">
							{{ csrf_field() }}
							...
							<input type="submit" class="btn btn-dark" value="Buat PO">
						</form>
                        @endforeach
					</body>
				</html>
