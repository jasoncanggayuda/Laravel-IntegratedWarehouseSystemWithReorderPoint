        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <!DOCTYPE html>
                    ...
                    <body>
						<a href="/SPB/BuatSurat"> Kembali</a>
						
						<br/>
						<br/>
                        
                        @foreach($_surat_p_o as $s)
						<form action="/PO/SuratPO/update" method="post">
							{{ csrf_field() }}
							...
							<input id="2" type="number" class="form-control" name="harga_satuan" placeholder="Harga Satuan"  value="{{ $s->harga_satuan }}" required="required" onblur="recalc()"> <br/>
